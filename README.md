...
## Introduction
This repository documents process of implementing SLAM for Autonomous Docking of SVs. The prototype vessels used in this project utilizes a `Livox MID-360 LiDAR` and a `Jetson Orin Nano Super DevKit` for performing SLAM.
